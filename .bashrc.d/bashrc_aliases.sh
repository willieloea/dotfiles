...
alias aia="cd ~/uni/cs791/assignments/24717274assignment3 && code . && xdg-open admin/assignment3.pdf && exit"
...
alias pr="cd ~/uni/cs771/project/ && code . && xdg-open workbook/resources/pampara.pdf"
